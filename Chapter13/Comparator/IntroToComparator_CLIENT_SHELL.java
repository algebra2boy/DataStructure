...
public class IntroToComparator_CLIENT_SHELL
{
   ...
   String codeWords[] = {"Foxtrot", "alpha", "echo", "golf",
            ...
            Arrays.sort(codeWords, new LengthComparator()); // use length comparator to sort     
            System.out.print("[");
            for (int i=0; i<codeWords.length-1; i++) 
                System.out.print(codeWords[i] + ", ");
            System.out.println(codeWords[codeWords.length-1]+"]");     
            ...
            System.out.print(" Pg 826 Arrays.sort(codeWords, new NumberOfUpperCases()): ");             
            Arrays.sort(codeWords, new NumberOfUpperCases()); 
            System.out.print("[");
            for (int i=0; i<codeWords.length-1; i++) 
                System.out.print(codeWords[i] + ", ");
            System.out.println(codeWords[codeWords.length-1]+"]");     
