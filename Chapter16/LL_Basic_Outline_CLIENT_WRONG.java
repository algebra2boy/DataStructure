...
public class LL_Basic_Outline_CLIENT_WRONG
{
    ...
    // ==================================================================================    
    public static void inputNum(ListNode h)   // WRONG!!! 'h' was passed the value of head iow: null :(
    {
    ListNode n;
    ListNode current;
    int k;
    ...
    // ==================================================================================   
    public static void printList(ListNode h)  // WRONG!!! :(
    {
    ListNode current=h;  // WRONG!!! :(
