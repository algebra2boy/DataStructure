...
public abstract class AbstractGraph<V> implements Graph<V>
{
    ...
    /* returns a List<Integer> that contains all the vertices in a path from u to v in this order*/
    public List<Integer> getPath(int u, int v)
    {
        List<Integer> path = new ArrayList<Integer>();
        AbstractGraph<Integer>.Tree bfs = (AbstractGraph<Integer>.Tree) this.bfs(u);

        int index = v;
        while(bfs.parent[index] != -1){
            path.add(index);
            index = bfs.parent[index];

            if(bfs.parent[index] == -1) {path.add(index);}
        }
        return path;
    }
...
// -----------------------------------------------------------------------------------------------------
    ...
    public class Tree
    {
        ...
        /** Return an arrayist representing search order */
